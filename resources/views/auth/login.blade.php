         ...
         <div class="order__left centered">
            <div class="form">
               ...
               <h2 class="text-center">
                ...
                @error('email')
                        <div class="alert alert-success alert-dismissible">
                            <strong>Email yang anda masukkan tidak terdaftar di sistem</strong>
                        </div>
                @enderror
                @error('password')
                        <div class="alert alert-success alert-dismissible">
                ...
                <form class="form-signin" method="POST" action="{{ route('login') }}">
                   ...
                   <div class="justify__space_between">   
                      ...
                      <a href="{{ route('auth.password.reset') }}" class="forgot__password">Forgot Password?</a>
                   </div>
               ...
               <div class="signup">
                  ...
                  Belum punya akun ?</label><a href="{{route('register')}}" class="forgot__password" style="text-decoration: none;"><strong>Daftar Disini.</strong></a>
                  <hr><small style="font-size: 12.5px;">*silahkan cek email anda untuk mengetahui update status akun anda</small>
               </div>
