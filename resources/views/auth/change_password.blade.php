         ...
         <div class="order__left centered">
            <div class="form">
               ...
               <h6 class="text-center">
                ...
                <form class="form-signin" method="PATCH" action="{{ url('auth.change_password') }}">
                    @csrf
                    <div class="row">
                   ...
                   <button type="submit" class="login__button">Recover Password</button>
                </form>
               
               <div class="signup">
                  <label class="remember_me">
                  Sudah punya akun ?</label><a href="{{route('login')}}" class="forgot__password" style="text-decoration: none;"><strong>Silahkan Masuk Disini.</strong></a>
               </div>
