...
<div id="app">
         ...
         <div class="order__left centered">
            <div class="form">
               <div class="logo">
                  <!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 530.59 103.21" class="h-6 w-auto">-->
               ...
               <h6 class="text-center">
                ...
                @endif
                {!! Form::open(['url' => route('photoboot.store'), 'method' => 'post', 'files' => true, 'id' => 'myform']) !!}
                    @csrf
                    
                    <a href="javascript: void(0);">
                        <img id="preview-image-before-upload" src="{{ asset('images/profile.png') }}" class="rounded mr-75" alt="profile image" height="100" width="100">
                    </a>
                    <div class="media-body mt-25">
                        <div class="col-12 px-0 d-flex flex-sm-row flex-column justify-content-start">
                            <label class="btn btn-xs btn-primary ml-50 mb-50 mb-sm-0 cursor-pointer" for="account-upload">Upload photo</label>
                            <input type="file" name="image" id="account-upload" hidden="" required>
                        </div>
                        <p class="text-muted ml-25 mt-10"><small>Allowed JPG, GIF or PNG.</small></p>
                    </div>
                    
                    <textarea class="form-control" placeholder="Caption" name="caption" required autofocus style="cursor: pointer;" autocomplete="off"></textarea>
                    @error('caption')
                    ...
                    <input type="text" id="link" name="link" placeholder="Link Upload IG" autocomplete="off" required>
                   @error('link')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input type="text" id="name" name="name" placeholder="Nama" autocomplete="off" required>
                   @error('name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input type="text" id="address" name="address" placeholder="Alamat" autocomplete="off" required>
                   @error('address')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <input type="number" id="phone" name="phone" placeholder="No. Telpon/ Whatsapp" autocomplete="off" required>
                   @error('phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
               ...
               <div class="signup">
                  <label class="remember_me"></label>
                  <hr><small style="font-size: 11.5px;">*setelah proses upload, foto akan melalui penjurian internal dan akan diumumkan pada laman ini kemudian hari.</small>
               </div>
