<div class="modal-dialog modal-lg" role="document">
    {!! Form::open(['url' => route('videos.store'), 'method' => 'post', 'files' => true, 'id' => 'myform']) !!}
        ...
        <div class="modal-body">
            <div class="form-group">
                <label class="filelabel form-control">
                    ...
                    <input class="FileUpload1 form-control" id="FileInput" name="file" type="file" required accept="video/mp4,video/x-m4v,video/*"/>
                </label>
            ...
            <div class="form-group">
                ...
                {!! Form::text('url', null, ['class' => 'form-control', 'required', 'placeholder' => '', 'oninvalid' => "this.setCustomValidity('Mohon diisi dengan lengkap')", 'oninput' => "this.setCustomValidity('')"]) !!}
            </div>
        </div>
        <div class="modal-footer">
            <button id="submit-doc" type="submit" class="btn btn-primary">Simpan</button>
        </div>
    </div>
    {!! Form::close() !!}
