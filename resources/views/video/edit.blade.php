<div class="modal-dialog modal-lg" role="document">
    {!! Form::open(['url' => route('videos.update', [$data->id]), 'method' => 'put', 'files' => true, 'id' => 'myform']) !!}
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLabel">Edit Video</h5>
        ...
        <div class="modal-body">
            <div class="form-group">
                <label class="filelabel form-control">
                    ...
                    <input class="FileUpload1 form-control" id="FileInput" name="file" type="file" accept="video/mp4,video/x-m4v,video/*"/>
                </label>
            ...
            <div class="form-group">
                ...
                {!! Form::text('url', $data->url, ['class' => 'form-control', 'required', 'placeholder' => '', 'oninvalid' => "this.setCustomValidity('Mohon diisi dengan lengkap')", 'oninput' => "this.setCustomValidity('')"]) !!}
            </div>
        </div>
