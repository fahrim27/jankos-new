<div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLabel">Detail Transfer</h5>
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                {!! Form::text('norek', $data->norek, ['class' => 'form-control', 'readonly', 'placeholder' => '', 'oninvalid' => "this.setCustomValidity('Mohon diisi dengan lengkap')", 'oninput' => "this.setCustomValidity('')"]) !!}
            </div>
            <div class="form-group">
                <img src="{{ asset('storage/uploads/tf/'.$data->image) }}" width="100%" height="100%" scrolling="no" style="border: none;"></iframe>
            </div>
        </div>
    </div>
