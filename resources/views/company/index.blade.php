...
<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title mb-0">Data Pengajuan Akun Tim Sekolah</h2>
            </div>
        </div>
    </div>
</div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (auth()->user()->id != $value->id || !auth()->user()->hasRole('Super Admin') || !auth()->user()->hasRole('Admin'))
                                                        ...
                                                        <a class="badge badge-pill badge-primary" style="cursor: pointer;" href="{{ route('access-request.edit', [$value->id]) }}"><i class="feather icon-edit" title="Edit"> Validasi Request</i></a>
