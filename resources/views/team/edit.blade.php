<div class="modal-dialog modal-lg" role="document">
    {!! Form::open(['url' => route('teams.update', [$data->id]), 'method' => 'put', 'files' => true, 'id' => 'myform']) !!}
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Edit Peserta Kategori Lomba {{$data->category->name}}</h6>
