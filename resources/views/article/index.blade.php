...
<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title mb-0">Data Artikel</h2>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button class="btn btn-outline-primary btn-modal" data-href="{{ route('articles.create') }}"><i class='feather icon-plus'></i> Tambah</button>
                    </div>
                                    ...
                                    <tbody>
                                        @foreach ($data as $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->title ?? '' }}</td>
                                                <td>
                                                    <a target="_blank" href="{{ Storage::url('uploads-1/uploads-2/uploads/slider/'.$value->thumbnail ?? '') }}">{{ $value->thumbnail }}
                                                    </a>
                                                </td>
                                                <td>
