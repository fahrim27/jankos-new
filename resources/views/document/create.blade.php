<div class="modal-dialog modal-lg" role="document">
    {!! Form::open(['url' => route('documents.store'), 'method' => 'post', 'files' => true, 'id' => 'myform']) !!}
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLabel">Tambah Dokumen</h5>
        ...
        <div class="modal-body">
            <div class="form-group">
                <label class="filelabel form-control">
                    ...
                    <input class="FileUpload1 form-control" id="FileInput" name="file" type="file" required />
                </label>
