...
<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title mb-0">Data Laporan Penjualan</h2>
            </div>
        </div>
    </div>
</div>
                                ...
                                <table class="table table-striped datatable">
                                    ...
                                    <tbody>
                                        @foreach ($data as $value)
                                            <tr>
                                                <td>
                                                    <span class="btn-show badge badge-pill badge-primary" style="cursor: pointer;" data-href="{{ route('logbooks.show', [$value->id]) }}"><i class="feather icon-image" title="Image"></i></span>
                                                </td> 
                                                <td>{{ $value->title ?? '' }}</td>
